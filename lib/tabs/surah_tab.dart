...
import 'package:ui_quran/screens/detail_screen.dart';

class SurahTab extends StatelessWidget {
  const SurahTab({super.key});

  Future<List<Datum>> _getSurahList() async {
    String data = await rootBundle.loadString('assets/data/listSurah.json');
    Surah surah = Surah.fromJson(json.decode(data));
      ...
      builder: (context, snapshot) {
        ...
        return ListView.separated(
          ...
          separatorBuilder: (context, index) => Divider(
            color: const Color(0XFFB2C4D1).withOpacity(.35),
          ),
  ...
  Widget _surahItem({required Datum surah, required BuildContext context}) =>
      GestureDetector(
